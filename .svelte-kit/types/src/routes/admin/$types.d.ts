...
type LayoutRouteId = RouteId | "/admin" | "/admin/bank-soal" | "/admin/bank-soal/[examId]" | "/admin/classes" | "/admin/exams" | "/admin/exams/type/[typeId]" | "/admin/exams/type/[typeId]/class/[classId]" | "/admin/exams/[id]" | "/admin/exams/[id]/analisis" | "/admin/exams/[id]/jawaban-siswa" | "/admin/media-bank" | "/admin/monitor" | "/admin/papan-peringkat" | "/admin/papan-peringkat/type/[typeId]" | "/admin/papan-peringkat/type/[typeId]/exams" | "/admin/papan-peringkat/[examId]" | "/admin/reset-login" | "/admin/results" | "/admin/results/[attemptId]" | "/admin/school-profile" | "/admin/students" | "/admin/subjects" | "/admin/tokens" | "/admin/users"
type LayoutParams = RouteParams & { examId?: string | undefined; typeId?: string | undefined; classId?: string | undefined; id?: string | undefined; attemptId?: string | undefined }
