...
return {
	...
	_: {
		...
		routes: [
			...
			{
				id: "/admin/exams/[id]/jawaban-siswa",
				pattern: /^\/admin\/exams\/([^/]+?)\/jawaban-siswa\/?$/,
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/exam-type-proctors/_server.ts.js'))
			},
			{
			...
			},
			{
				...
				params: [{"name":"typeId","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/export-results/type/_typeId_/_server.ts.js'))
			},
			{
			...
			{
				id: "/api/export/analisis/[examId]",
				pattern: /^\/api\/export\/analisis\/([^/]+?)\/?$/,
				params: [{"name":"examId","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/export/analisis/_examId_/_server.ts.js'))
			},
			{
			...
			},
			{
				...
				params: [{"name":"examId","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/export/jawaban-siswa/_examId_/_server.ts.js'))
			},
			{
				id: "/api/heartbeat",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/heartbeat/_server.ts.js'))
			},
			{
				id: "/api/logout",
				pattern: /^\/api\/logout\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/profile/qr-token/_server.ts.js'))
			},
			{
				id: "/api/proxy-media",
			...
			{
				id: "/guru/bank-soal/[examId]/jawaban-siswa",
				pattern: /^\/guru\/bank-soal\/([^/]+?)\/jawaban-siswa\/?$/,
				params: [{"name":"examId","optional":false,"rest":false,"chained":false}],
			...
			{
				id: "/print/analisis/[examId]",
				pattern: /^\/print\/analisis\/([^/]+?)\/?$/,
				params: [{"name":"examId","optional":false,"rest":false,"chained":false}],
			...
			},
			{
				...
				params: [],
				page: { layouts: [0,7,], errors: [1,,], leaf: 83 },
				endpoint: null
			}
		],
