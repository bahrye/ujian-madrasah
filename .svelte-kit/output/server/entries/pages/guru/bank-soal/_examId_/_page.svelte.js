import { h as head, i as attr, e as escape_html, c as ensure_array_like, b as bind_props } from "../../../../../chunks/index.js";
        ...
        if (q.options_json) {
          ...
          if (Array.isArray(opts)) {
            ...
            for (let i = 0, $$length2 = each_array_5.length; i < $$length2; i++) {
              ...
              $$renderer2.push(`<span class="text-[10px] px-2 py-0.5 rounded-md bg-slate-100 text-slate-600">${escape_html(String.fromCharCode(65 + i))}. ${escape_html(opt)}</span>`);
            }
            $$renderer2.push(`<!--]--></div>`);
          } else {
            $$renderer2.push("<!--[-1-->");
