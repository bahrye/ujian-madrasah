...
function _page($$renderer) {
  ...
  $$renderer.push(`<!--]--></div></div></div> <div class="bg-white rounded-3xl p-6 md:p-10 border border-slate-200 shadow-sm relative overflow-hidden"><div class="text-center max-w-2xl mx-auto mb-12 relative z-10"><span class="text-indigo-600 font-semibold tracking-wider uppercase text-sm mb-2 block">Panduan Antarmuka</span> <h2 class="text-3xl font-bold text-slate-800 mb-4">Mengenal Halaman Ujian</h2> <p class="text-slate-500">Berikut adalah penjelasan mengenai fungsi-fungsi tombol dan informasi yang ada pada halaman pengerjaan ujian.</p></div> <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center"><div class="relative mx-auto w-full max-w-sm rounded-2xl overflow-hidden border-4 border-slate-100 shadow-xl bg-slate-50"><img src="/panduan-ui-ujian.jpeg" alt="Antarmuka Ujian" class="w-full h-auto block object-cover"/> <div class="absolute w-5 h-5 md:w-6 md:h-6 rounded-full bg-indigo-600/95 ring-2 ring-white text-white flex items-center justify-center text-[10px] md:text-xs font-bold shadow-md hover:scale-125 transition-transform cursor-default" style="top: 3%; left: 3%;">1</div> <div class="absolute w-5 h-5 md:w-6 md:h-6 rounded-full bg-indigo-600/95 ring-2 ring-white text-white flex items-center justify-center text-[10px] md:text-xs font-bold shadow-md hover:scale-125 transition-transform cursor-default" style="top: 3%; left: 52%;">2</div> <div class="absolute w-5 h-5 md:w-6 md:h-6 rounded-full bg-indigo-600/95 ring-2 ring-white text-white flex items-center justify-center text-[10px] md:text-xs font-bold shadow-md hover:scale-125 transition-transform cursor-default" style="top: 3%; left: 90%;">3</div> <div class="absolute w-5 h-5 md:w-6 md:h-6 rounded-full bg-indigo-600/95 ring-2 ring-white text-white flex items-center justify-center text-[10px] md:text-xs font-bold shadow-md hover:scale-125 transition-transform cursor-default" style="top: 15%; left: 90%;">4</div> <div class="absolute w-5 h-5 md:w-6 md:h-6 rounded-full bg-indigo-600/95 ring-2 ring-white text-white flex items-center justify-center text-[10px] md:text-xs font-bold shadow-md hover:scale-125 transition-transform cursor-default" style="top: 30%; left: 3%;">5</div> <div class="absolute w-5 h-5 md:w-6 md:h-6 rounded-full bg-indigo-600/95 ring-2 ring-white text-white flex items-center justify-center text-[10px] md:text-xs font-bold shadow-md hover:scale-125 transition-transform cursor-default" style="top: 55%; left: 3%;">6</div> <div class="absolute w-5 h-5 md:w-6 md:h-6 rounded-full bg-indigo-600/95 ring-2 ring-white text-white flex items-center justify-center text-[10px] md:text-xs font-bold shadow-md hover:scale-125 transition-transform cursor-default" style="top: 85%; left: 3%;">7</div> <div class="absolute w-5 h-5 md:w-6 md:h-6 rounded-full bg-indigo-600/95 ring-2 ring-white text-white flex items-center justify-center text-[10px] md:text-xs font-bold shadow-md hover:scale-125 transition-transform cursor-default" style="top: 85%; left: 40%;">8</div> <div class="absolute w-5 h-5 md:w-6 md:h-6 rounded-full bg-indigo-600/95 ring-2 ring-white text-white flex items-center justify-center text-[10px] md:text-xs font-bold shadow-md hover:scale-125 transition-transform cursor-default" style="top: 85%; left: 88%;">9</div> <div class="absolute w-5 h-5 md:w-6 md:h-6 rounded-full bg-indigo-600/95 ring-2 ring-white text-white flex items-center justify-center text-[10px] md:text-xs font-bold shadow-md hover:scale-125 transition-transform cursor-default" style="top: 96%; left: 88%;">10</div></div> <div class="space-y-2"><!--[-->`);
