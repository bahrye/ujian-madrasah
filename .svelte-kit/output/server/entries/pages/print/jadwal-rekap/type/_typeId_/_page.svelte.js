...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (days.length === 0) {
      ...
      $$renderer2.push("<!--[-1-->");
      $$renderer2.push(`<div class="w-full"><table${attr_class(`w-full border-collapse border-2 border-black whitespace-nowrap ${"text-xs"}`)}><thead><tr class="bg-gray-100 text-black font-bold"><th${attr_class(`border-2 border-black ${"px-1.5 py-1.5 w-8"} text-center uppercase`)}>NO</th><th${attr_class(`border-2 border-black ${"px-2 py-1.5 w-36"} text-center uppercase`)}>HARI, TANGGAL</th><th${attr_class(`border-2 border-black ${"px-1.5 py-1.5 w-12"} text-center uppercase`)}>JAM KE</th><th${attr_class(`border-2 border-black ${"px-2 py-1.5 w-28"} text-center uppercase`)}>WAKTU</th><th${attr_class(`border-2 border-black ${"px-2 py-1.5"} text-center uppercase`)}>MATA PELAJARAN</th><th${attr_class(`border-2 border-black ${"px-1.5 py-1.5 w-20"} text-center uppercase`)}>PENGAWAS</th><th${attr_class(`border-2 border-black ${"px-2 py-1.5 w-44"} text-left uppercase`)}>DAFTAR PENGAWAS</th></tr></thead><tbody><!--[-->`);
      ...
      for (let gIdx = 0, $$length = each_array.length; gIdx < $$length; gIdx++) {
        ...
        for (let eIdx = 0, $$length2 = each_array_1.length; eIdx < $$length2; eIdx++) {
          ...
          if (gIdx === 0 && eIdx === 0) {
            $$renderer2.push("<!--[0-->");
            $$renderer2.push(`<td${attr_class(`border-2 border-black ${"px-2 py-1.5"} align-top bg-white`)}${attr("rowspan", totalExams)}><div class="space-y-1 text-xs"><!--[-->`);
