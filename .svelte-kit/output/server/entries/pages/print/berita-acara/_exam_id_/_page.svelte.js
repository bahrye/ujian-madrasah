    ...
    for (let roomIdx = 0, $$length = each_array_4.length; roomIdx < $$length; roomIdx++) {
      ...
      for (let sessionIdx = 0, $$length2 = each_array_5.length; sessionIdx < $$length2; sessionIdx++) {
        ...
        $$renderer2.push(`<!--]--></div> <div class="mt-2 mb-5"><div style="border-bottom: 1px solid #000;"></div> <div style="border-bottom: 2.5px solid #000; margin-top: 2px;"></div></div> <div class="text-center mb-6"><h1 class="font-bold text-lg uppercase underline tracking-wider mb-1">BERITA ACARA PELAKSANAAN UJIAN</h1> <p class="text-sm font-medium">Tahun Ajaran ${escape_html(getAcademicYear(effectiveStart))}</p></div> <p class="mb-4 text-justify">Pada hari ini <span class="border-b border-dotted border-black px-2">${escape_html(getDayName(effectiveStart))}</span> tanggal <span class="border-b border-dotted border-black px-2">${escape_html(getDayNumber(effectiveStart))}</span> bulan <span class="border-b border-dotted border-black px-2">${escape_html(getMonthName(effectiveStart))}</span> tahun <span class="border-b border-dotted border-black px-2">${escape_html(getYearNumber(effectiveStart))}</span>, 
				telah diselenggarakan <strong class="uppercase">${escape_html(exam.exam_type_name || exam.title)}</strong> Mata Pelajaran <strong>${escape_html(exam.subject_name || "Umum")}</strong> untuk:</p> <div class="ml-4 mb-6"><table class="w-full"><tbody><tr class="align-top"><td class="w-48 py-1">a. Satuan Pendidikan</td><td class="w-4 py-1">:</td><td class="py-1 font-bold uppercase">${escape_html(school?.name || "-")}</td></tr><tr class="align-top"><td class="py-1">b. Ruang / Sesi Ujian</td><td class="py-1">:</td><td class="py-1 font-bold">${escape_html(roomName)} / Sesi ${escape_html(sessionNum)}</td></tr><tr class="align-top"><td class="py-1">c. Waktu Pelaksanaan</td><td class="py-1">:</td><td class="py-1">${escape_html(formatTime(effectiveStart))} s.d. ${escape_html(formatTime(effectiveEnd))} WIB</td></tr><tr class="align-top"><td class="py-1">d. Jumlah Peserta Seharusnya</td><td class="py-1">:</td><td class="py-1">${escape_html(count)} Orang</td></tr><tr class="align-top"><td class="py-1">e. Jumlah Peserta Hadir</td><td class="py-1">:</td><td class="py-1">........... Orang</td></tr><tr class="align-top"><td class="py-1">f. Jumlah Peserta Tidak Hadir</td><td class="py-1">:</td><td class="py-1">........... Orang</td></tr><tr class="align-top"><td class="py-1.5 pl-4 text-sm font-sans" colspan="3"><div class="flex items-baseline gap-2"><span>- Nomor Peserta yang Tidak Hadir:</span> <span class="border-b border-dotted border-black flex-1 min-h-[1.2rem]"></span></div> <div class="mt-1.5"><span class="border-b border-dotted border-black block w-full min-h-[1.2rem]"></span></div></td></tr></tbody></table></div> <div class="mb-6"><p class="mb-2 font-bold">Catatan / Kejadian Penting Selama Ujian Berlangsung:</p> <div class="border border-black p-3 min-h-[90px] text-xs font-mono text-slate-500 rounded"><span class="print:hidden">( Kosongkan jika pelaksanaan ujian berjalan tertib dan lancar )</span></div></div> <p class="mb-8">Demikian Berita Acara ini dibuat dengan sesungguhnya untuk dipergunakan sebagaimana mestinya.</p> <div class="mt-8 text-sm font-serif">`);
        if (activeOfficers.length <= 1) {
          $$renderer2.push("<!--[0-->");
          $$renderer2.push(`<div class="grid grid-cols-2 gap-8 text-center"><div><div class="h-6"></div> <p class="font-medium mb-14">Kepala Madrasah,</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(school?.principal_name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(school?.principal_nip || "..............................")}</p></div> <div><p class="text-xs text-slate-700 mb-1">${escape_html(locationCity)}, ${escape_html(formatDateFull(effectiveStart))}</p> <p class="font-medium mb-14">${escape_html(activeOfficers[0]?.role === "Pengawas I" ? "Pengawas Ruang" : activeOfficers[0]?.role || "Pengawas Ruang")},</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(activeOfficers[0]?.data?.name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(activeOfficers[0]?.data?.nip || "..............................")}</p></div></div>`);
        } else if (activeOfficers.length === 2) {
          $$renderer2.push("<!--[1-->");
          $$renderer2.push(`<div class="grid grid-cols-2 gap-8 text-center"><div><div class="h-6"></div> <p class="font-medium mb-14">${escape_html(activeOfficers[0].role)},</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(activeOfficers[0].data?.name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(activeOfficers[0].data?.nip || "..............................")}</p></div> <div><p class="text-xs text-slate-700 mb-1">${escape_html(locationCity)}, ${escape_html(formatDateFull(effectiveStart))}</p> <p class="font-medium mb-14">${escape_html(activeOfficers[1].role)},</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(activeOfficers[1].data?.name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(activeOfficers[1].data?.nip || "..............................")}</p></div> <div></div> <div class="mt-4"><p class="font-medium mb-14">Kepala Madrasah,</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(school?.principal_name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(school?.principal_nip || "..............................")}</p></div></div>`);
        } else if (activeOfficers.length === 3) {
          $$renderer2.push("<!--[2-->");
          $$renderer2.push(`<div class="grid grid-cols-2 gap-8 text-center"><div><div class="h-6"></div> <p class="font-medium mb-14">${escape_html(activeOfficers[0].role)},</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(activeOfficers[0].data?.name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(activeOfficers[0].data?.nip || "..............................")}</p></div> <div><p class="text-xs text-slate-700 mb-1">${escape_html(locationCity)}, ${escape_html(formatDateFull(effectiveStart))}</p> <p class="font-medium mb-14">${escape_html(activeOfficers[1].role)},</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(activeOfficers[1].data?.name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(activeOfficers[1].data?.nip || "..............................")}</p></div> <div class="mt-4"><p class="font-medium mb-14">${escape_html(activeOfficers[2].role)},</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(activeOfficers[2].data?.name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(activeOfficers[2].data?.nip || "..............................")}</p></div> <div class="mt-4"><p class="font-medium mb-14">Kepala Madrasah,</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(school?.principal_name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(school?.principal_nip || "..............................")}</p></div></div>`);
        } else {
          $$renderer2.push("<!--[-1-->");
          $$renderer2.push(`<div class="grid grid-cols-2 gap-8 text-center"><div><div class="h-6"></div> <p class="font-medium mb-14">${escape_html(activeOfficers[0].role)},</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(activeOfficers[0].data?.name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(activeOfficers[0].data?.nip || "..............................")}</p></div> <div><p class="text-xs text-slate-700 mb-1">${escape_html(locationCity)}, ${escape_html(formatDateFull(effectiveStart))}</p> <p class="font-medium mb-14">${escape_html(activeOfficers[1].role)},</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(activeOfficers[1].data?.name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(activeOfficers[1].data?.nip || "..............................")}</p></div> <div class="mt-4"><p class="font-medium mb-14">${escape_html(activeOfficers[2].role)},</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(activeOfficers[2].data?.name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(activeOfficers[2].data?.nip || "..............................")}</p></div> <div class="mt-4"><p class="font-medium mb-14">${escape_html(activeOfficers[3].role)},</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(activeOfficers[3].data?.name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(activeOfficers[3].data?.nip || "..............................")}</p></div> <div></div> <div class="mt-4"><p class="font-medium mb-14">Kepala Madrasah,</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(school?.principal_name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(school?.principal_nip || "..............................")}</p></div></div>`);
        }
