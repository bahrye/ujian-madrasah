    ...
    for (let roomIdx = 0, $$length = each_array_4.length; roomIdx < $$length; roomIdx++) {
      ...
      for (let sessionIdx = 0, $$length2 = each_array_5.length; sessionIdx < $$length2; sessionIdx++) {
        ...
        $$renderer2.push(`<!--]--></div> <div class="mt-2 mb-3"><div style="border-bottom: 1px solid #000;"></div> <div style="border-bottom: 2.5px solid #000; margin-top: 2px;"></div></div> <div class="text-center mb-3"><h1 class="font-bold text-lg uppercase underline tracking-wider mb-0.5">BERITA ACARA PELAKSANAAN UJIAN</h1> <p class="text-sm font-medium">Tahun Ajaran ${escape_html(getAcademicYear(effectiveStart))}</p></div> <p class="mb-2 text-justify">Pada hari ini <span class="border-b border-dotted border-black px-2">${escape_html(getDayName(effectiveStart))}</span> tanggal <span class="border-b border-dotted border-black px-2">${escape_html(getDayNumber(effectiveStart))}</span> bulan <span class="border-b border-dotted border-black px-2">${escape_html(getMonthName(effectiveStart))}</span> tahun <span class="border-b border-dotted border-black px-2">${escape_html(getYearNumber(effectiveStart))}</span>, 
				telah diselenggarakan <strong class="uppercase">${escape_html(exam.exam_type_name || exam.title)}</strong> Mata Pelajaran <strong>${escape_html(exam.subject_name || "Umum")}</strong> untuk:</p> <div class="ml-4 mb-3"><table class="w-full"><tbody><tr class="align-top"><td class="w-48 py-0.5">a. Satuan Pendidikan</td><td class="w-4 py-0.5">:</td><td class="py-0.5 font-bold uppercase">${escape_html(school?.name || "-")}</td></tr><tr class="align-top"><td class="py-0.5">b. Ruang / Sesi Ujian</td><td class="py-0.5">:</td><td class="py-0.5 font-bold">${escape_html(roomName)} / Sesi ${escape_html(sessionNum)}</td></tr><tr class="align-top"><td class="py-0.5">c. Waktu Pelaksanaan</td><td class="py-0.5">:</td><td class="py-0.5">${escape_html(formatTime(effectiveStart))} s.d. ${escape_html(formatTime(effectiveEnd))} WIB</td></tr><tr class="align-top"><td class="py-0.5">d. Jumlah Peserta Seharusnya</td><td class="py-0.5">:</td><td class="py-0.5">${escape_html(count)} Orang</td></tr><tr class="align-top"><td class="py-0.5">e. Jumlah Peserta Hadir</td><td class="py-0.5">:</td><td class="py-0.5">........... Orang</td></tr><tr class="align-top"><td class="py-0.5">f. Jumlah Peserta Tidak Hadir</td><td class="py-0.5">:</td><td class="py-0.5">........... Orang</td></tr><tr class="align-top"><td class="py-1 pl-4 text-sm font-sans" colspan="3"><div class="flex items-baseline gap-2"><span>- Nomor Peserta yang Tidak Hadir:</span> <span class="border-b border-dotted border-black flex-1 min-h-[1.1rem]"></span></div> <div class="mt-1"><span class="border-b border-dotted border-black block w-full min-h-[1.1rem]"></span></div></td></tr></tbody></table></div> <div class="mb-3"><p class="mb-1 font-bold text-sm">Catatan / Kejadian Penting Selama Ujian Berlangsung:</p> <div class="border border-black p-2 min-h-[48px] text-xs font-serif text-slate-500 rounded"><span class="print:hidden">( Kosongkan jika pelaksanaan ujian berjalan tertib dan lancar )</span></div></div> <p class="mb-3">Demikian Berita Acara ini dibuat dengan sesungguhnya untuk dipergunakan sebagaimana mestinya.</p> <div class="mt-4 text-sm font-serif">`);
        if (activeOfficers.length <= 1) {
          $$renderer2.push("<!--[0-->");
          $$renderer2.push(`<div class="grid grid-cols-2 gap-4 text-center"><div><div class="h-5"></div> <p class="font-medium mb-9">Kepala Madrasah,</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(school?.principal_name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(school?.principal_nip || "..............................")}</p></div> <div><p class="text-xs text-slate-700 mb-0.5">${escape_html(locationCity)}, ${escape_html(formatDateFull(effectiveStart))}</p> <p class="font-medium mb-9">${escape_html(activeOfficers[0]?.role === "Pengawas I" ? "Pengawas Ruang" : activeOfficers[0]?.role || "Pengawas Ruang")},</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(activeOfficers[0]?.data?.name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(activeOfficers[0]?.data?.nip || "..............................")}</p></div></div>`);
        } else if (activeOfficers.length === 2) {
          $$renderer2.push("<!--[1-->");
          $$renderer2.push(`<div class="grid grid-cols-2 gap-4 text-center"><div><div class="h-5"></div> <p class="font-medium mb-9">${escape_html(activeOfficers[0].role)},</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(activeOfficers[0].data?.name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(activeOfficers[0].data?.nip || "..............................")}</p></div> <div><p class="text-xs text-slate-700 mb-0.5">${escape_html(locationCity)}, ${escape_html(formatDateFull(effectiveStart))}</p> <p class="font-medium mb-9">${escape_html(activeOfficers[1].role)},</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(activeOfficers[1].data?.name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(activeOfficers[1].data?.nip || "..............................")}</p></div> <div></div> <div class="mt-2"><p class="font-medium mb-9">Kepala Madrasah,</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(school?.principal_name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(school?.principal_nip || "..............................")}</p></div></div>`);
        } else if (activeOfficers.length === 3) {
          $$renderer2.push("<!--[2-->");
          $$renderer2.push(`<div class="grid grid-cols-2 gap-4 text-center"><div><div class="h-5"></div> <p class="font-medium mb-9">${escape_html(activeOfficers[0].role)},</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(activeOfficers[0].data?.name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(activeOfficers[0].data?.nip || "..............................")}</p></div> <div><p class="text-xs text-slate-700 mb-0.5">${escape_html(locationCity)}, ${escape_html(formatDateFull(effectiveStart))}</p> <p class="font-medium mb-9">${escape_html(activeOfficers[1].role)},</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(activeOfficers[1].data?.name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(activeOfficers[1].data?.nip || "..............................")}</p></div> <div class="mt-2"><p class="font-medium mb-9">${escape_html(activeOfficers[2].role)},</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(activeOfficers[2].data?.name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(activeOfficers[2].data?.nip || "..............................")}</p></div> <div class="mt-2"><p class="font-medium mb-9">Kepala Madrasah,</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(school?.principal_name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(school?.principal_nip || "..............................")}</p></div></div>`);
        } else {
          $$renderer2.push("<!--[-1-->");
          $$renderer2.push(`<div class="grid grid-cols-2 gap-4 text-center"><div><div class="h-5"></div> <p class="font-medium mb-9">${escape_html(activeOfficers[0].role)},</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(activeOfficers[0].data?.name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(activeOfficers[0].data?.nip || "..............................")}</p></div> <div><p class="text-xs text-slate-700 mb-0.5">${escape_html(locationCity)}, ${escape_html(formatDateFull(effectiveStart))}</p> <p class="font-medium mb-9">${escape_html(activeOfficers[1].role)},</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(activeOfficers[1].data?.name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(activeOfficers[1].data?.nip || "..............................")}</p></div> <div class="mt-2"><p class="font-medium mb-9">${escape_html(activeOfficers[2].role)},</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(activeOfficers[2].data?.name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(activeOfficers[2].data?.nip || "..............................")}</p></div> <div class="mt-2"><p class="font-medium mb-9">${escape_html(activeOfficers[3].role)},</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(activeOfficers[3].data?.name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(activeOfficers[3].data?.nip || "..............................")}</p></div> <div></div> <div class="mt-2"><p class="font-medium mb-9">Kepala Madrasah,</p> <p class="border-b border-black font-bold inline-block px-3">${escape_html(school?.principal_name || "( .................................... )")}</p> <p class="text-xs mt-1">NIP. ${escape_html(school?.principal_nip || "..............................")}</p></div></div>`);
        }
