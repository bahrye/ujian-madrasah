...
declare module "$app/types" {
	...
	export interface AppTypes {
		RouteId(): "/" | "/admin" | "/admin/bank-soal" | "/admin/bank-soal/[examId]" | "/admin/bank-soal/[examId]/preview" | "/admin/classes" | "/admin/exams" | "/admin/exams/type" | "/admin/exams/type/[typeId]" | "/admin/exams/type/[typeId]/class" | "/admin/exams/type/[typeId]/class/[classId]" | "/admin/exams/[id]" | "/admin/exams/[id]/analisis" | "/admin/media-bank" | "/admin/monitor" | "/admin/papan-peringkat" | "/admin/papan-peringkat/type" | "/admin/papan-peringkat/type/[typeId]" | "/admin/papan-peringkat/type/[typeId]/exams" | "/admin/papan-peringkat/[examId]" | "/admin/results" | "/admin/results/[attemptId]" | "/admin/school-profile" | "/admin/students" | "/admin/subjects" | "/admin/tokens" | "/admin/users" | "/api" | "/api/attempt-status" | "/api/attempt-status/[id]" | "/api/delete-media" | "/api/exam-type-classes" | "/api/exam-type-proctors" | "/api/exams" | "/api/exams/[id]" | "/api/exams/[id]/questions" | "/api/export-results" | "/api/export-results/type" | "/api/export-results/type/[typeId]" | "/api/export-results/[examId]" | "/api/export" | "/api/export/excel" | "/api/export/excel/[exam_id]" | "/api/heartbeat" | "/api/logout" | "/api/media" | "/api/migrate-sessions" | "/api/monitor-live" | "/api/profile" | "/api/proxy-media" | "/api/setup" | "/api/track-media" | "/guru" | "/guru/bank-soal" | "/guru/bank-soal/[examId]" | "/guru/bank-soal/[examId]/analisis" | "/guru/bank-soal/[examId]/preview" | "/guru/media-bank" | "/guru/papan-peringkat" | "/guru/papan-peringkat/type" | "/guru/papan-peringkat/type/[typeId]" | "/guru/papan-peringkat/type/[typeId]/exams" | "/guru/papan-peringkat/[examId]" | "/guru/penilaian" | "/guru/remedial" | "/guru/remedial/[examId]" | "/guru/results" | "/guru/results/[attemptId]" | "/login" | "/pengawas" | "/pengawas/jadwal" | "/pengawas/jadwal/saya" | "/pengawas/jadwal/semua" | "/pengawas/monitor" | "/pengawas/reset-login" | "/pengawas/tata-tertib" | "/pengawas/tokens" | "/print" | "/print/berita-acara" | "/print/berita-acara/type" | "/print/berita-acara/type/[typeId]" | "/print/berita-acara/[exam_id]" | "/print/jadwal-rekap" | "/print/jadwal-rekap/type" | "/print/jadwal-rekap/type/[typeId]" | "/print/jadwal" | "/print/jadwal/type" | "/print/jadwal/type/[typeId]" | "/print/kartu" | "/print/kartu/type" | "/print/kartu/type/[typeId]" | "/print/kartu/[exam_id]" | "/print/kehadiran" | "/print/kehadiran/type" | "/print/kehadiran/type/[typeId]" | "/print/kehadiran/[exam_id]" | "/print/results" | "/print/results/[attemptId]" | "/siswa" | "/siswa/hasil-ujian" | "/siswa/jadwal" | "/siswa/papan-peringkat" | "/siswa/papan-peringkat/type" | "/siswa/papan-peringkat/type/[typeId]" | "/siswa/papan-peringkat/type/[typeId]/exams" | "/siswa/papan-peringkat/[examId]" | "/siswa/tata-tertib" | "/siswa/ujian" | "/siswa/ujian/[attemptId]" | "/superadmin" | "/superadmin/accounts" | "/superadmin/admins" | "/superadmin/schools";
		RouteParams(): {
		...
		LayoutParams(): {
			...
			"/api/export-results/type/[typeId]": { typeId: string };
			"/api/export-results/[examId]": { examId: string };
			"/api/export": { exam_id?: string | undefined };
			...
			"/print": { typeId?: string | undefined; exam_id?: string | undefined; attemptId?: string | undefined };
		...
		Pathname(): "/" | "/admin" | "/admin/bank-soal" | `/admin/bank-soal/${string}` & {} | `/admin/bank-soal/${string}/preview` & {} | "/admin/classes" | "/admin/exams" | `/admin/exams/type/${string}` & {} | `/admin/exams/type/${string}/class/${string}` & {} | `/admin/exams/${string}` & {} | `/admin/exams/${string}/analisis` & {} | "/admin/media-bank" | "/admin/monitor" | "/admin/papan-peringkat" | `/admin/papan-peringkat/type/${string}` & {} | `/admin/papan-peringkat/type/${string}/exams` & {} | `/admin/papan-peringkat/${string}` & {} | "/admin/results" | `/admin/results/${string}` & {} | "/admin/school-profile" | "/admin/students" | "/admin/subjects" | "/admin/tokens" | "/admin/users" | `/api/attempt-status/${string}` & {} | "/api/delete-media" | "/api/exam-type-classes" | "/api/exam-type-proctors" | `/api/exams/${string}/questions` & {} | `/api/export-results/type/${string}` & {} | `/api/export-results/${string}` & {} | `/api/export/excel/${string}` & {} | "/api/heartbeat" | "/api/logout" | "/api/media" | "/api/migrate-sessions" | "/api/monitor-live" | "/api/profile" | "/api/proxy-media" | "/api/setup" | "/api/track-media" | "/guru" | "/guru/bank-soal" | `/guru/bank-soal/${string}` & {} | `/guru/bank-soal/${string}/analisis` & {} | `/guru/bank-soal/${string}/preview` & {} | "/guru/media-bank" | "/guru/papan-peringkat" | `/guru/papan-peringkat/type/${string}` & {} | `/guru/papan-peringkat/type/${string}/exams` & {} | `/guru/papan-peringkat/${string}` & {} | "/guru/penilaian" | "/guru/remedial" | `/guru/remedial/${string}` & {} | "/guru/results" | `/guru/results/${string}` & {} | "/login" | "/pengawas" | "/pengawas/jadwal/saya" | "/pengawas/jadwal/semua" | "/pengawas/monitor" | "/pengawas/reset-login" | "/pengawas/tata-tertib" | "/pengawas/tokens" | `/print/berita-acara/type/${string}` & {} | `/print/berita-acara/${string}` & {} | `/print/jadwal-rekap/type/${string}` & {} | `/print/jadwal/type/${string}` & {} | `/print/kartu/type/${string}` & {} | `/print/kartu/${string}` & {} | `/print/kehadiran/type/${string}` & {} | `/print/kehadiran/${string}` & {} | `/print/results/${string}` & {} | "/siswa" | "/siswa/hasil-ujian" | "/siswa/jadwal" | "/siswa/papan-peringkat" | `/siswa/papan-peringkat/type/${string}` & {} | `/siswa/papan-peringkat/type/${string}/exams` & {} | `/siswa/papan-peringkat/${string}` & {} | "/siswa/tata-tertib" | "/siswa/ujian" | `/siswa/ujian/${string}` & {} | "/superadmin" | "/superadmin/accounts" | "/superadmin/admins" | "/superadmin/schools";
		ResolvedPathname(): `${"" | `/${string}`}${ReturnType<AppTypes['Pathname']>}`;
		Asset(): "/favicon.svg" | "/kemenag.png" | "/panduan-ui-ujian.jpeg" | "/template_soal_ujian.docx" | string & {};
	}
}