...
declare module "$app/types" {
	...
	export interface AppTypes {
		...
		LayoutParams(): {
			"/": { examId?: string | undefined; typeId?: string | undefined; id?: string | undefined; attemptId?: string | undefined; exam_id?: string | undefined };
		...
		Pathname(): "/" | "/admin" | "/admin/bank-soal" | `/admin/bank-soal/${string}` & {} | `/admin/bank-soal/${string}/preview` & {} | "/admin/classes" | "/admin/exams" | `/admin/exams/type/${string}` & {} | `/admin/exams/${string}` & {} | `/admin/exams/${string}/analisis` & {} | "/admin/media-bank" | "/admin/monitor" | "/admin/papan-peringkat" | `/admin/papan-peringkat/type/${string}` & {} | `/admin/papan-peringkat/type/${string}/exams` & {} | `/admin/papan-peringkat/${string}` & {} | "/admin/results" | `/admin/results/${string}` & {} | "/admin/school-profile" | "/admin/students" | "/admin/subjects" | "/admin/tokens" | "/admin/users" | `/api/attempt-status/${string}` & {} | "/api/delete-media" | "/api/exam-type-classes" | `/api/exams/${string}/questions` & {} | `/api/export-results/${string}` & {} | `/api/export/excel/${string}` & {} | "/api/logout" | "/api/media" | "/api/migrate-sessions" | "/api/profile" | "/api/proxy-media" | "/api/setup" | "/api/track-media" | "/guru" | "/guru/bank-soal" | `/guru/bank-soal/${string}` & {} | `/guru/bank-soal/${string}/preview` & {} | "/guru/media-bank" | "/guru/papan-peringkat" | `/guru/papan-peringkat/type/${string}` & {} | `/guru/papan-peringkat/type/${string}/exams` & {} | `/guru/papan-peringkat/${string}` & {} | "/guru/penilaian" | "/guru/remedial" | `/guru/remedial/${string}` & {} | "/guru/results" | `/guru/results/${string}` & {} | "/login" | "/pengawas" | "/pengawas/jadwal/saya" | "/pengawas/jadwal/semua" | "/pengawas/monitor" | "/pengawas/tata-tertib" | "/pengawas/tokens" | `/print/berita-acara/${string}` & {} | `/print/jadwal/type/${string}` & {} | `/print/kartu/type/${string}` & {} | `/print/kartu/${string}` & {} | `/print/kehadiran/${string}` & {} | "/siswa" | "/siswa/hasil-ujian" | "/siswa/jadwal" | "/siswa/papan-peringkat" | `/siswa/papan-peringkat/type/${string}` & {} | `/siswa/papan-peringkat/type/${string}/exams` & {} | `/siswa/papan-peringkat/${string}` & {} | "/siswa/tata-tertib" | "/siswa/ujian" | `/siswa/ujian/${string}` & {} | "/superadmin" | "/superadmin/accounts" | "/superadmin/admins" | "/superadmin/schools";
		ResolvedPathname(): `${"" | `/${string}`}${ReturnType<AppTypes['Pathname']>}`;
		Asset(): "/favicon.svg" | "/panduan-ui-ujian.jpeg" | "/template_soal_ujian.docx" | string & {};
	}
}