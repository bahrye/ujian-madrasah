...
declare module "$app/types" {
	...
	export interface AppTypes {
		...
		LayoutParams(): {
			...
			"/print": { typeId?: string | undefined; exam_id?: string | undefined };
