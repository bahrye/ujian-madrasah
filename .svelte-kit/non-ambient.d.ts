...
declare module "$app/types" {
	...
	export interface AppTypes {
		...
		LayoutParams(): {
			...
			"/api": { id?: string | undefined; examId?: string | undefined; exam_id?: string | undefined };
