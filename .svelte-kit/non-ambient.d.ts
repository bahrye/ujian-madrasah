...
declare module "$app/types" {
	...
	export interface AppTypes {
		...
		LayoutParams(): {
			...
			"/api/auth/check-pin": Record<string, never>;
			...
			"/api/student": Record<string, never>;
			"/api/student/log-violation": Record<string, never>;
			"/api/student/save-single": Record<string, never>;
			...
			"/print/results/[attemptId]": { attemptId: string };
			"/print/users": Record<string, never>;
		...
		Pathname(): "/" | "/admin" | "/admin/bank-soal" | `/admin/bank-soal/${string}` & {} | `/admin/bank-soal/${string}/preview` & {} | "/admin/classes" | "/admin/exams" | `/admin/exams/type/${string}` & {} | `/admin/exams/type/${string}/class/${string}` & {} | `/admin/exams/${string}` & {} | `/admin/exams/${string}/analisis` & {} | `/admin/exams/${string}/jawaban-siswa` & {} | "/admin/media-bank" | "/admin/monitor" | "/admin/papan-peringkat" | `/admin/papan-peringkat/type/${string}` & {} | `/admin/papan-peringkat/type/${string}/exams` & {} | `/admin/papan-peringkat/${string}` & {} | "/admin/reset-login" | "/admin/results" | `/admin/results/${string}` & {} | "/admin/school-profile" | "/admin/students" | "/admin/subjects" | "/admin/tokens" | "/admin/users" | `/api/attempt-status/${string}` & {} | "/api/auth/check-pin" | "/api/delete-media" | "/api/exam-type-classes" | "/api/exam-type-proctors" | `/api/exams/${string}/questions` & {} | `/api/export-results/type/${string}` & {} | `/api/export-results/${string}` & {} | `/api/export/analisis/${string}` & {} | `/api/export/excel/${string}` & {} | `/api/export/jawaban-siswa/${string}` & {} | "/api/heartbeat" | "/api/logout" | "/api/media" | "/api/migrate-sessions" | "/api/monitor-live" | "/api/profile" | "/api/profile/qr-token" | "/api/proxy-media" | "/api/setup" | "/api/student/log-violation" | "/api/student/save-single" | "/api/track-media" | "/guru" | "/guru/bank-soal" | `/guru/bank-soal/${string}` & {} | `/guru/bank-soal/${string}/analisis` & {} | `/guru/bank-soal/${string}/jawaban-siswa` & {} | `/guru/bank-soal/${string}/preview` & {} | "/guru/media-bank" | "/guru/papan-peringkat" | `/guru/papan-peringkat/type/${string}` & {} | `/guru/papan-peringkat/type/${string}/exams` & {} | `/guru/papan-peringkat/${string}` & {} | "/guru/penilaian" | "/guru/remedial" | `/guru/remedial/${string}` & {} | "/guru/results" | `/guru/results/${string}` & {} | "/login" | "/pengawas" | "/pengawas/jadwal/saya" | "/pengawas/jadwal/semua" | "/pengawas/monitor" | "/pengawas/reset-login" | "/pengawas/tata-tertib" | "/pengawas/tokens" | `/print/analisis/${string}` & {} | `/print/berita-acara/type/${string}` & {} | `/print/berita-acara/${string}` & {} | `/print/jadwal-rekap/type/${string}` & {} | `/print/jadwal/type/${string}` & {} | `/print/jawaban-siswa/${string}` & {} | `/print/kartu/type/${string}` & {} | `/print/kartu/${string}` & {} | `/print/kehadiran/type/${string}` & {} | `/print/kehadiran/${string}` & {} | `/print/results/${string}` & {} | "/print/users" | "/siswa" | "/siswa/hasil-ujian" | "/siswa/jadwal" | "/siswa/papan-peringkat" | `/siswa/papan-peringkat/type/${string}` & {} | `/siswa/papan-peringkat/type/${string}/exams` & {} | `/siswa/papan-peringkat/${string}` & {} | "/siswa/tata-tertib" | "/siswa/ujian" | `/siswa/ujian/${string}` & {} | "/superadmin" | "/superadmin/accounts" | "/superadmin/admins" | "/superadmin/schools";
		ResolvedPathname(): `${"" | `/${string}`}${ReturnType<AppTypes['Pathname']>}`;
		Asset(): "/.assetsignore" | "/favicon.svg" | "/kemenag.png" | "/panduan-ui-ujian-2.jpeg" | "/panduan-ui-ujian-3.jpeg" | "/panduan-ui-ujian.jpeg" | "/template_soal_ujian.docx" | string & {};
	}
}