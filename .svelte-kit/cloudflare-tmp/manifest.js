	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/auth/check-pin/_server.ts.js'))
			},
			{
				id: "/api/delete-media",
			...
			},
			{
				...
				params: [{"name":"examId","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/export/analisis/_examId_/_server.ts.js'))
			},
			{
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/student/log-violation/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/student/save-single/_server.ts.js'))
			},
			{
				id: "/api/track-media",
