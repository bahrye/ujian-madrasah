	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				pattern: /^\/superadmin\/?$/,
				params: [],
				page: { layouts: [0,7,], errors: [1,,], leaf: 64 },
				endpoint: null
			},
			{
