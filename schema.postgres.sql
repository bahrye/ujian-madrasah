-- ============================================
-- Schema Database Ujian Madrasah / CBT (PostgreSQL / Neon)
-- ============================================

-- Function Compatibility: datetime('now')
CREATE OR REPLACE FUNCTION datetime(arg text DEFAULT 'now') RETURNS text AS $$
BEGIN
...
-- 4. Tabel Pengguna (Superadmin, Admin, Guru, Pengawas, Siswa, Panitia)
...
CREATE TABLE IF NOT EXISTS student_attempts (
    ...
    start_time TEXT NOT NULL DEFAULT (to_char(NOW(), 'YYYY-MM-DD HH24:MI:SS')),
    end_time TEXT,
    submit_time TEXT,
...
-- 15. Tabel Peserta per Tipe Ujian
...
-- 18. Tabel Pengawas per Tipe Ujian
...
-- 19. Tabel Pelacak Media (Media Logs / Orphan Tracker)
