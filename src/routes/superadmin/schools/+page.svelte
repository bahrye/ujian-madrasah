<script lang="ts">
	...
	$: if (form?.error) {
		...
		addToast('Berhasil menyimpan data sekolah', 'success');
		isAdding = false;
	}
</script>
						...
						<tr class="hover:bg-slate-50 transition-colors">
							...
							<td class="p-4 text-right">
								<form method="POST" action="?/toggleStatus" use:enhance class="inline-block">
									...
									<button type="submit" class="text-sm {school.is_active ? 'text-red-600 hover:text-red-700' : 'text-green-600 hover:text-green-700'} font-medium">
