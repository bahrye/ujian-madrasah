...
<div class="space-y-6 animate-in">
	<!-- Header -->
	<div class="mb-8">
		<a href="/siswa/papan-peringkat/type/{data.exam.exam_type_id}/exams" class="inline-flex items-center text-sm font-medium text-primary-600 hover:text-primary-700 mb-4 transition-colors">
